 ...
 * Ruby 2.3.8, 2.4.6, 2.5.6 and 2.6.3; JRuby 9.2.0.0.
   * RVM is used to manage Ruby versions. [Why RVM?](#why_rvm)
   * 2.5.6 is configured as the default.
...
# Ruby 2.5.6
RUN bash -lc 'rvm --default use ruby-2.5.6'
# Ruby 2.6.3
...
```bash
$ rvm-exec 2.5.6 ruby -v
ruby 2.5.6
$ rvm-exec 2.4.6 ruby -v
ruby 2.4.6
```
...
```bash
# This runs 'bundle install' using Ruby 2.5.6
rvm-exec 2.5.6 bundle install

# This runs 'bundle install' using Ruby 2.4.6
rvm-exec 2.4.6 bundle install
```
