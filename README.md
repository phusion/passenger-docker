 ...
 * Ruby 3.2.8, 3.3.8, 3.4.3 and JRuby 9.3.15.0 and 9.4.9.0.
   * RVM is used to manage Ruby versions. [Why RVM?](#why_rvm)
   * 3.4.3 is configured as the default.
...
$ rvm-exec 3.4.3 ruby -v
Using /usr/local/rvm/gems/ruby-3.4.3
...
```bash
# This runs 'bundle install' using Ruby 3.4.3
rvm-exec 3.4.3 bundle install
```
