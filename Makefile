...
build_customizable:
	...
	docker build -q -t $(NAME)-customizable:$(VERSION) -rm customizable_image
...
build_ruby18:
	...
	docker build -q -t $(NAME)-ruby18:$(VERSION) -rm ruby18_image
...
build_ruby19:
	...
	docker build -q -t $(NAME)-ruby19:$(VERSION) -rm ruby19_image
...
build_ruby20:
	...
	docker build -q -t $(NAME)-ruby20:$(VERSION) -rm ruby20_image
...
build_ruby21:
	...
	docker build -q -t $(NAME)-ruby21:$(VERSION) -rm ruby21_image
...
build_nodejs:
	...
	docker build -q -t $(NAME)-nodejs:$(VERSION) -rm nodejs_image
...
build_full:
	...
	docker build -q -t $(NAME)-full:$(VERSION) -rm full_image
