...
## This script is to be run after ruby2.0.sh, ruby2.1.sh,
## ruby2.1.sh, ruby2.2.sh, ruby2.3.sh and jruby9.1.sh.
...
echo "gem: --no-document --bindir /usr/local/bin" > /etc/gemrc
